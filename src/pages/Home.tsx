export default function Home() {
  return (
    <div className="bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white min-h-screen">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-700/30 p-6 rounded-lg border border-slate-600">
              ...
              <h3 className="font-semibold mb-2">Понимание себя</h3>
              <p className="text-slate-300">Разберись в своих эмоциях и паттернах поведения</p>
            </div>
            <div className="bg-slate-700/30 p-6 rounded-lg border border-slate-600">
              <div className="text-2xl mb-3">💪</div>
              <h3 className="font-semibold mb-2">Уверенность</h3>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-6 p-6 bg-indigo-900/20 rounded-lg border-l-4 border-indigo-400">
              <div className="bg-indigo-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold flex-shrink-0">1</div>
              <div>
                <h3 className="font-bold text-indigo-300 mb-2">Руководство</h3>
                <p className="text-slate-300">LIMINAL помогает распознать паттерны и эмоции</p>
              </div>
            </div>
            
            <div className="flex items-start gap-6 p-6 bg-purple-900/20 rounded-lg border-l-4 border-purple-400">
              ...
              <div>
                <h3 className="font-bold text-purple-300 mb-2">Со-навигация</h3>
                <p className="text-slate-300">Ты начинаешь распознавать их сам</p>
              </div>
            </div>
            
            <div className="flex items-start gap-6 p-6 bg-pink-900/20 rounded-lg border-l-4 border-pink-400">
              <div className="bg-pink-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold flex-shrink-0">3</div>
              <div>
                <h3 className="font-bold text-pink-300 mb-2">Внутренний совет</h3>
                <p className="text-slate-300">Эмоции становятся союзниками</p>
              </div>
            </div>
            
            <div className="flex items-start gap-6 p-6 bg-emerald-900/20 rounded-lg border-l-4 border-emerald-400">
              ...
              <div>
                <h3 className="font-bold text-emerald-300 mb-2">Суверенность</h3>
      ...
      {/* Email CTA */}
      <section className="bg-gradient-to-r from-indigo-900/50 to-pink-900/50 py-16 px-6">
